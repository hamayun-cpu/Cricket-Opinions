...
class OpinionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create opinion' do
    assert_difference('Opinion.count') do
      post opinions_url, params: { opinion: { author_id: @opinion.author_id, thought: @opinion.thought } }
    end
  ...
  test 'should update opinion' do
    patch opinion_url(@opinion), params: { opinion: { author_id: @opinion.author_id, thought: @opinion.thought } }
